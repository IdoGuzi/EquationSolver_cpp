...
TEST_CASE("basic real"){
    ...
    CHECK((solve(4*(x^2)-2==14)==2 || solve(4*(x^2)-2==14)==-2));
    CHECK(solve(2==x*2)==1);
    ...
    CHECK(solve(4*x+1==3)==0.5);
    CHECK(solve(2*x==1)==0.5);
    CHECK(solve(x==1)==1);
    CHECK(solve(x+x==2)==1);
    CHECK(solve(2*x+x==3)==1);
    CHECK(solve(x*4==3)==3.0/4.0);
...
TEST_CASE("more real trinoms"){
    ...
    CHECK(solve(9*(x^2)+6*x+1==0)==-1/3.0);
    ...
    CHECK(solve(4*(x^2)+12*x+9==0)==-1.5);
    CHECK((solve(2*(x^2)+6*x+4==0)==-1 || solve(2*(x^2)+6*x+4==0)==-2));
    CHECK((solve(2*(x^2)+9*x+4==0)==-1/2.0 || solve(2*(x^2)+9*x+4==0)==-4));
...
TEST_CASE("basic complex"){
    ...
    CHECK(solve(3*x-4i*3i==1)==complex<double>(-11/3.0,0));
    CHECK(solve(x*3-5i==2)==complex<double>(2/3.0,5/3.0));
    CHECK(solve(x*2-2==2i)==complex<double>(1,1));
    CHECK(solve(x*3-2+x*5+4==3i-2i+5i)==complex<double>(-1/4.0,3/4.0));
...
TEST_CASE("complex trinom"){
    ...
    CHECK((solve((x^2)-2*x+2==0)==complex<double>(-1,-1) || solve((x^2)-2*x+2==0)==complex<double>(1,-1)));
    CHECK((solve((x^2)+16==0)==complex<double>(0,-4) || solve((x^2)+16==0)==complex<double>(0,4)));
    CHECK((solve((x^2)+2*x+10==0)==complex<double>(-1,3) || solve((x^2)+2*x+10==0)==complex<double>(-1,-3)));
    CHECK((solve(4*(x^2)+4==0)==complex<double>(0,-1) || solve(4*(x^2)+4==0)==complex<double>(0,1)));
    CHECK((solve(4*(x^2)+9==0)==complex<double>(0,-3/2.0) || solve(4*(x^2)+9==0)==complex<double>(0,3/2.0)));
    CHECK((solve(2*(x^2)+2*x+13==0)==complex<double>(-1/2.0,5/2.0) || solve(2*(x^2)+2*x+13==0)==complex<double>(-1/2.0,-5/2.0)));
    ...
    CHECK((solve(5*(x^2)+4*x+8==0)==complex<double>(-2/5.0,6/5.0) || solve(5*(x^2)+4*x+8==0)==complex<double>(-2/5.0,-6/5.0)));
...
TEST_CASE("complex throws/notthrow"){
    ...
    CHECK_THROWS(solve(x*x*x*x*x/(x^3)==1));
    CHECK_THROWS(solve(x/(x^2)==1));
    CHECK_THROWS(solve(0-x-x-x-x/0));
    CHECK_THROWS(solve(0*x==1));
    CHECK_THROWS(solve(x*0+2));
    CHECK_THROWS(solve(x^(2/-8)));
    CHECK_NOTHROW(solve(x*0i));
